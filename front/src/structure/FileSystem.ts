...
export class FileSystemFile extends FileSystemNode {
	...
	constructor(arg0: string | FileSystemFileSchema, parent: FileSystemParent, content: string = "") {
...
export class FileSystemDirectory extends FileSystemParent {
	...
	constructor(name: string, parent: FileSystemParent, children?: Array<FileSystemNode>);
	constructor(arg0: string | FileSystemDirectorySchema, parent: FileSystemParent, children: Array<FileSystemNode> = []) {
		if (typeof arg0 === "string") {
			super(arg0, children);
		} else {
			if (arg0.children) {
...
export class FileSystemRoot extends FileSystemParent {
	...
	constructor(schema: Array<FileSystemSchema> = []) {
		super("");
		this.children = schema.map((childSchema: FileSystemSchema) => childSchema.type == "file" ? new FileSystemFile(childSchema, this) : new FileSystemDirectory(childSchema, this))
	}
}
